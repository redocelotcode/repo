...
class PackageMetricsData
{
    ...
    {
        $this->_id = $dbRow["id"];
        $this->_abstract_class_count = $dbRow["abstract_class_count"];
        $this->_afferent_coupling = $dbRow["afferent_coupling"];
        $this->_analyzed_at = $dbRow["analyzed_at"];
        $this->_average_complexity = $dbRow["average_complexity"];
        $this->_average_method_loc = $dbRow["average_method_loc"];
        $this->_avg_class_cohesion = $dbRow["avg_class_cohesion"];
        $this->_avg_class_complexity = $dbRow["avg_class_complexity"];
        $this->_avg_class_loc = $dbRow["avg_class_loc"];
        $this->_code_smells_count = $dbRow["code_smells_count"];
        ...
        $this->_efferent_coupling = $dbRow["efferent_coupling"];
        $this->_external_dependencies_count = $dbRow["external_dependencies_count"];
        $this->_file_count = $dbRow["file_count"];
        $this->_god_class_count = $dbRow["god_class_count"];
        $this->_high_complexity_methods = $dbRow["high_complexity_methods"];
        $this->_instability = $dbRow["instability"];
        $this->_interface_count = $dbRow["interface_count"];
        $this->_language = $dbRow["language"];
        $this->_maintainability_index = $dbRow["maintainability_index"];
        $this->_max_class_complexity = $dbRow["max_class_complexity"];
        $this->_max_class_loc = $dbRow["max_class_loc"];
        $this->_max_complexity = $dbRow["max_complexity"];
        $this->_package_complexity = $dbRow["package_complexity"];
        $this->_package_loc = $dbRow["package_loc"];
        ...
        $this->_technical_debt_minutes = $dbRow["technical_debt_minutes"];
        $this->_technical_debt_ratio = $dbRow["technical_debt_ratio"];
        $this->_total_classes = $dbRow["total_classes"];
        $this->_total_methods = $dbRow["total_methods"];
        $this->_very_high_complexity_methods = $dbRow["very_high_complexity_methods"];
